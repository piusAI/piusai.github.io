---
layout: default
title: "PIUS | Combat & Engine Lab"
permalink: /
---

# ⚔️ PIUS : Combat & Engine Lab

> **"To be honest, I need to study more and more everything, so why don't you just start now!"**
> 늘 배움의 경계를 넓히며, 상황에 맞는 본질적인 해결 방법을 고민하는 C++ 프로그래머 황효준입니다.
...
* **Languages:** **C++**, Houdini VEX, C#, Python
* **Artstation:** 🎨 [piusai 아트포트폴리오 바로가기](https://www.artstation.com/piusai)

### 🎨 DCC Tools (Technical Art)
* **Procedural Setup:** **Houdini** (절차적 에셋 및 VFX 시뮬레이션 구현)
  * 🎬 [Houdini 작업 영상 확인](https://www.youtube.com/watch?v=X0O2rIlcTxs)
