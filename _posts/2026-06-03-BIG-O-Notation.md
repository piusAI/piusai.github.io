...
description: Big-O 표기법에 대하여 정리한 글
thumbnail-img: postimg/Big-O/Big-O.jpg
categories:
- C++
tags:
- cpp
...
![Big-o]({{ 'assets/postimg/Big-O/Big-O.jpg' | relative_url }})

log(N)도 많이 훌륭한 것이다.
훌륭한 Sort 알고리즘의 Big-O는 Nlog(N)을 넘어가지 않는다.

![Logn]({{ '/assets/postimg/Big-O/Logn.png' | relative_url }})
