...
| Step 03 | Step 04 | 
|----------|----------|
| <img src="{{ '/assets/postimg/RenderPipeline/DccWorkFlow_004.jpg' | relative_url }}" width="500"> | <img src="{{ '/assets/postimg/RenderPipeline/DccWorkFlow_005.jpg' | relative_url }}" width="500"> | 
